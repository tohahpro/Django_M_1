...
from tasks.views import employee_dashboard, manager_dashboard, create_task,task_details ,update_task, delete_task, dashboard, Greetings, CreateTask, ViewProject, TaskDetail, UpdateTask
...
urlpatterns = [
    ...
    path('view-tasks/', ViewProject.as_view(), name='view-tasks')
]